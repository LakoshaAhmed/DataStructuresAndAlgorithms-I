...
3. If you want to use STL library data structures, such as std::vector, std::stack, std:: unordered_map etc in any task of the course, you have to implement them yourself.
...
## Code-review passing algorithm
 ...
 10. In pull request comments send the **link to the successfully passed run report**.
